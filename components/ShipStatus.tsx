...
const ShipStatus: React.FC<ShipStatusProps> = ({ 
  ...
  const targetEntity = selectedTargetId ? [...gameState.currentSector.entities, gameState.player.ship].find(e => e.id === selectedTargetId) : null;
      ...
      >
        ...
        <div className="mt-3">
            ...
            <div className="flex flex-col gap-2 mt-1">
                ...
                />
                <PhaserArrayStatus ship={ship} gameState={gameState} targetEntity={targetEntity} />
