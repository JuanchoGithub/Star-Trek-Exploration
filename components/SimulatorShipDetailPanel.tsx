...
import type { GameState, Entity, Ship, ShipSubsystems, Planet, Starbase, TorpedoProjectile, Mine } from '../types';
...
// FIX: Import AIDirector to calculate AI targeting decisions for display.
             ...
             <div className="mt-2">
                ...
                {targetOfSelected ? (
                    <div className="text-xs text-text-secondary pl-2">
                        ...
                        {/* FIX: Re-calculate AI targeting decision for display. Player targeting is not implemented in simulator dogfight mode. */}
                        {(() => {
                            let targetedSubsystem: keyof ShipSubsystems | null = null;
                            if (ship.allegiance === 'player') {
                                // Player targeting in dogfight is not implemented
