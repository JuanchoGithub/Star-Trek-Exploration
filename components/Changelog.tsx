...
import { Version1_5_2, Version1_5_1, Version1_5, Version1_4_1, Version1_4, Version1_3_2 } from './changelog/index';

type Version = 'v1.5.2' | 'v1.5.1' | 'v1.5' | 'v1.4.1' | 'v1.4' | 'v1.3.2';
...
const Changelog: React.FC<ChangelogProps> = ({ onClose }) => {
    const [activeVersion, setActiveVersion] = useState<Version>('v1.5.2');
