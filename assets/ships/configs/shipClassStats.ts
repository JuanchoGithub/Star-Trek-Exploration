...
export const shipClasses: Record<ShipModel, Record<string, ShipClassStats>> = {
    Federation: {
        'Sovereign-class': {
            ...
            torpedoes: { max: 20 }, torpedoType: 'Quantum', securityTeams: { max: 8 }, shuttleCount: 6, dilithium: { max: 20 },
        },
        'Constitution-class': {
            ...
            torpedoes: { max: 10 }, torpedoType: 'Photon', securityTeams: { max: 5 }, shuttleCount: 4, dilithium: { max: 20 },
        },
        'Galaxy-class': {
            ...
            torpedoes: { max: 12 }, torpedoType: 'Photon', securityTeams: { max: 6 }, shuttleCount: 8, dilithium: { max: 20 },
        },
        'Intrepid-class': {
            ...
            torpedoes: { max: 6 }, torpedoType: 'Photon', securityTeams: { max: 3 }, shuttleCount: 2, dilithium: { max: 20 },
        },
        'Defiant-class': {
            ...
            torpedoes: { max: 8 }, torpedoType: 'Quantum', securityTeams: { max: 4 }, shuttleCount: 1, dilithium: { max: 20 },
        },
    },
    Klingon: {
        'B\'rel-class Bird-of-Prey': {
            ...
            torpedoes: { max: 6 }, torpedoType: 'Photon', securityTeams: { max: 4 }, shuttleCount: 0, dilithium: { max: 1 },
        },
        'K\'t\'inga-class': {
            ...
            torpedoes: { max: 10 }, torpedoType: 'Photon', securityTeams: { max: 6 }, shuttleCount: 0, dilithium: { max: 1 },
        },
        'Vor\'cha-class': {
            ...
            torpedoes: { max: 12 }, torpedoType: 'Photon', securityTeams: { max: 8 }, shuttleCount: 0, dilithium: { max: 2 },
        },
        'Negh\'Var-class': {
            ...
            torpedoes: { max: 18 }, torpedoType: 'HeavyPhoton', securityTeams: { max: 10 }, shuttleCount: 0, dilithium: { max: 3 },
        },
    },
    Romulan: {
        'D\'deridex-class': {
            ...
            torpedoes: { max: 15 }, torpedoType: 'HeavyPlasma', securityTeams: { max: 7 }, shuttleCount: 0, dilithium: { max: 2 },
        },
        'Valdore-type': {
            ...
            torpedoes: { max: 8 }, torpedoType: 'Plasma', securityTeams: { max: 3 }, shuttleCount: 0, dilithium: { max: 1 },
        },
        'Scimitar-class': {
            ...
            torpedoes: { max: 25 }, torpedoType: 'HeavyPlasma', securityTeams: { max: 10 }, shuttleCount: 0, dilithium: { max: 3 },
        },
    },
    Pirate: {
        'Orion Raider': {
            ...
            torpedoes: { max: 4 }, torpedoType: 'Photon', securityTeams: { max: 2 }, shuttleCount: 0, dilithium: { max: 1 },
        },
        'Ferengi Marauder': {
            ...
            torpedoes: { max: 8 }, torpedoType: 'Photon', securityTeams: { max: 3 }, shuttleCount: 1, dilithium: { max: 2 },
        },
        'Nausicaan Battleship': {
            ...
            torpedoes: { max: 12 }, torpedoType: 'HeavyPhoton', securityTeams: { max: 5 }, shuttleCount: 0, dilithium: { max: 2 },
        },
    },
    Independent: {
        'Civilian Freighter': {
            ...
            torpedoes: { max: 2 }, torpedoType: 'None', securityTeams: { max: 1 }, shuttleCount: 1, dilithium: { max: 0 },
        }
    }
};