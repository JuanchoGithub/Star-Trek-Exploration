...
export const createShip = (
    ...
    const newShip: Ship = {
        ...
        crewMorale: { current: 100, max: 100 }, repairTarget: null, 
        repairPoints: { current: baseStats.repairPoints.max, max: baseStats.repairPoints.max }, repairRate: baseStats.repairRate,
        logColor: 'border-gray-400',
...
export const createInitialGameState = (): GameState => {
  ...
  const playerShip: Ship = {
    ...
    repairPoints: { current: playerStats.repairPoints.max, max: playerStats.repairPoints.max },
    repairRate: playerStats.repairRate,
